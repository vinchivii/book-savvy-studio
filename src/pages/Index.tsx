...
const Index = () => {
  return (
    <div className="min-h-screen gradient-background">
      {/* Header */}
      <header className="sticky top-0 z-50 w-full glass border-b-2 border-border/50 shadow-lg backdrop-blur-xl">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <Link to="/" className="text-2xl font-bold bg-gradient-accent bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(46,123,255,0.4)]">
            BrandBook
          </Link>
          <Button asChild variant="default" className="shadow-glow-sm">
            <Link to="/auth">
              Login
            </Link>
          </Button>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="inline-flex items-center gap-2 glass-card bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium animate-fade-in shadow-glow-sm">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight animate-fade-in">
              Your Business,
              <br />
              <span className="bg-gradient-accent bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(46,123,255,0.5)]">
                One Beautiful Link
              </span>
            </h1>
      ...
      <section id="features" className="py-20 relative">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <FeatureCard
              icon={<Calendar className="w-10 h-10 text-primary drop-shadow-[0_0_12px_rgba(46,123,255,0.5)]" />}
              title="Smart Booking"
              description="Clients book directly through your custom link. Set your services, pricing, and availability in minutes."
              delay="0.1s"
            />
            <FeatureCard
              icon={<Users className="w-10 h-10 text-primary drop-shadow-[0_0_12px_rgba(46,123,255,0.5)]" />}
              title="Client Management"
              description="Keep track of all your clients and their booking history in one organized dashboard."
              delay="0.2s"
            />
            <FeatureCard
              icon={<Sparkles className="w-10 h-10 text-primary drop-shadow-[0_0_12px_rgba(46,123,255,0.5)]" />}
      ...
      {/* CTA Section */}
      <section className="py-20 glass-panel mx-4 rounded-[2rem] shadow-glow relative overflow-hidden">
        <div 
          className="absolute inset-0 opacity-30"
          style={{ background: 'var(--gradient-accent)' }}
        />
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-primary-foreground drop-shadow-[0_0_20px_rgba(0,0,0,0.3)]">
...
const FeatureCard = ({ 
  ...
  <div 
    className="glass-panel p-8 hover-lift hover-glass animate-fade-up"
...
const StepCard = ({ 
  ...
  <div className="flex gap-6 items-start animate-fade-in" style={{ animationDelay: `${(parseInt(number) - 1) * 0.2}s` }}>
    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-accent text-primary-foreground flex items-center justify-center shadow-glow-sm">
